...
Usage:
    ...
    python scripts/smart_data_sync_v2.py --db data/kairos.duckdb
    
    # Check only (don't download)
    python scripts/smart_data_sync_v2.py --db data/kairos.duckdb --check-only
    
    # Sync specific tables
    python scripts/smart_data_sync_v2.py --db data/kairos.duckdb --tables SEP DAILY
    
    # Force download even if up to date
    python scripts/smart_data_sync_v2.py --db data/kairos.duckdb --force
...
Examples:
  ...
  python scripts/smart_data_sync_v2.py --db data/kairos.duckdb --tables SF1 --force
"""
    )
